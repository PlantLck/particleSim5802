...
/*
 * Sequential spatial grid update
 * Three-phase algorithm: Count -> Prefix Sum -> Fill
 * Enables O(n) collision detection by spatial partitioning
 */
...
void Simulation::update(float dt) {
    ...
    if (running) {
        ...
        // Delegate to appropriate physics engine based on mode
        switch (mode) {
